...
//constants for compony
defined('COMPONY_NAME')        OR define('COMPONY_NAME', 'Jastrack'); // no errors
defined('COMPONY_NAME_FULL')        OR define('COMPONY_NAME_FULL', 'JASTRACK LOGISTICS SERVICES PVT LTD'); // no errors
